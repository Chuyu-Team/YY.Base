...
namespace YY
{
    namespace Base
    {
        namespace Sync
        {
            ...
            struct InterlockedSingleLinkedEntryBase
            {
                Entry* pNext = nullptr;
            };

            template<class Entry, ProducerType eProducer = ProducerType::Multi, ConsumerType eConsumer = ConsumerType::Single>
            class InterlockedSingleLinkedList;

            template<class Entry>
            class InterlockedSingleLinkedList<Entry, ProducerType::Multi, ConsumerType::Single>
            {
            public:
                // 一般不应该直接操作此成员
                ...
                InterlockedSingleLinkedList(const InterlockedSingleLinkedList&) = delete;
                InterlockedSingleLinkedList& operator=(const InterlockedSingleLinkedList&) = delete;
