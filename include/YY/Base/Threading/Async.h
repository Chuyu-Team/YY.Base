    ...
    namespace Base
    {
        namespace Threading
        {
            ...
            public:
                ...
                void __YYAPI InvokeCompletedHandlers(auto&&... _args)
                {
            ...
            public:
                ~AsyncOperationImpl()
                {
                    if (this->GetStatus() == AsyncStatus::Completed)
                    {
                        oResult.~ResultType();
                    }
                }
                ...
                bool __YYAPI SetErrorCode(HRESULT _hr)
                {
                    return AsyncOperation<ResultType_>::SetErrorCode(_hr);
                }
            };
            ...
            public:
                ...
                bool __YYAPI SetErrorCode(HRESULT _hr)
                {
                    return AsyncOperation<void>::SetErrorCode(_hr);
                }
            };
            ...
            public:
                ...
                {
                    if (!AsyncOperation<ResultType_>::BeginNotifyCompletedHandlers(AsyncStatus::Completed))
                    {
                        return false;
                    }

                    lStatus = _lStatus;
                    AsyncOperation<ResultType_>::NotifyCompletedHandlers();
                    return true;
                }
