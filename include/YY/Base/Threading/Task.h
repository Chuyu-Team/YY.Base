    ...
    namespace Base
    {
        namespace Threading
        {
            ...
            static Task<HRESULT> __YYAPI WhenAll(const Tasks&... _Tasks)
            {
                ...
                size_t idx = 0;
                ((void)(_pWhenAllTaskAsyncOperation->pAsyncOperations[idx++] = (AsyncOperation<void>*)_Tasks.GetAsyncOperation().Get()), ...);
            ...
            static Task<int32_t> __YYAPI WhenAny(const Tasks&... _Tasks)
            {
                ...
                size_t idx = 0;
                ((void)(_pWhenAnyTaskAsyncOperation->pAsyncOperations[idx++] = (AsyncOperation<void>*)_Tasks.GetAsyncOperation().Get()), ...);
