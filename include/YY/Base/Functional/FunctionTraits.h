...
#pragma push_macro("__IF_VECTORCALL_SUPPORTED")
#undef __IF_VECTORCALL_SUPPORTED
...
#define __IF_VECTORCALL_SUPPORTED(...) __VA_ARGS__
#else
#define __IF_VECTORCALL_SUPPORTED(...)
#endif
...
#define __APPLY_FUNCTION_TRAITS(NOEXCEPT_SPEC)                     \
            ...
            __IF_VECTORCALL_SUPPORTED(__APPLY_FUNCTION_TRAITS2(__vectorcall, NOEXCEPT_SPEC))
...
#define __APPLY_CLASS_FUNCTION_TRAITS(NOEXCEPT_SPEC)                     \
            ...
            __IF_VECTORCALL_SUPPORTED(__APPLY_CLASS_FUNCTION_TRAITS2(__vectorcall, NOEXCEPT_SPEC))
...
#define __APPLY_FUNCTION_TRAITS(NOEXCEPT_SPEC)                     \
            __APPLY_FUNCTION_TRAITS2(   __DEFAULT, NOEXCEPT_SPEC)  \
            __IF_VECTORCALL_SUPPORTED(__APPLY_FUNCTION_TRAITS2(__vectorcall, NOEXCEPT_SPEC))

#define __APPLY_CLASS_FUNCTION_TRAITS(NOEXCEPT_SPEC)                     \
            __APPLY_CLASS_FUNCTION_TRAITS2(   __DEFAULT, NOEXCEPT_SPEC)  \
            __IF_VECTORCALL_SUPPORTED(__APPLY_CLASS_FUNCTION_TRAITS2(__vectorcall, NOEXCEPT_SPEC))
...
#undef __IF_VECTORCALL_SUPPORTED
#pragma pop_macro("__IF_VECTORCALL_SUPPORTED")
